...
export class RegularAttack implements IAttack {
    attackType = 'regular';
    attackRoll = Math.floor(Math.random() * (15 - 2) + 1); // Lower roll compared to special attacks
    attackDamage = Math.floor(Math.random() * (6 - 2) + 1); // Lower damage compared to special attacks
