...
describe("Player tests", () => {
    ...
    it("should reduce the players health on successful sword attack", () => {
        let result
    ...
    it("should reduce the players health on ice spell attack", () => {
        let result
    ...
    it("should reduce the players health on successful axe attack", () => {
        let result
